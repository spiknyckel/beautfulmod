...
public class NumericTextEntry extends StandardRowEntry<NumericTextEntry> implements IKeyboardEntry {
	...
	public NumericTextEntry(String title, String text, boolean reset, @NotNull String infoStr, boolean useInt) {
	...
	private void initEntrys(String text, boolean useInt) {
		field = new GuiNumericTextField(0, Minecraft.getInstance().textRenderer, 0, 0, 100, TEXTFIELD_HEIGHT, useInt);
		field.setText(text);
	}
