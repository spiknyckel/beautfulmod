...
public class GuiNumericTextField extends TextFieldWidget {
	...
	public GuiNumericTextField(int id, TextRenderer fontRenderer, int x, int y, int width, int height) {
		this(id, fontRenderer, x, y, width, height, true);
	}

	public GuiNumericTextField(int id, TextRenderer fontRenderer, int x, int y, int width, int height, boolean useInt) {
	...
	public void keyDown(char typedChar, int keyCode) {
		if (this.keyPressed(typedChar, keyCode)) {
